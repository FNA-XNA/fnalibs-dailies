...
hdiutil attach SDL-macos-framework/dist/SDL3-3.1.6-macOS.dmg
cp /Volumes/SDL3\ 3.1.6/SDL3.framework/SDL3 fnalibs-apple/osx/libSDL3.0.dylib
install_name_tool -id "@rpath/libSDL3.0.dylib" fnalibs-apple/osx/libSDL3.0.dylib
hdiutil detach /Volumes/SDL3\ 3.1.6
...
tar xvfz SDL-ios-arm64/dist/SDL3-3.1.6-iOS.tar.gz SDL3-3.1.5-iOS/lib/libSDL3.a
mv SDL3-3.1.6-iOS/lib/libSDL3.a fnalibs-apple/iphoneos/
...
tar xvfz SDL-tvos-arm64/dist/SDL3-3.1.6-tvOS.tar.gz SDL3-3.1.5-tvOS/lib/libSDL3.a
mv SDL3-3.1.6-tvOS/lib/libSDL3.a fnalibs-apple/appletvos/
