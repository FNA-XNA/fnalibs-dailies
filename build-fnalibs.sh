...
tar xvfz SDL-steamrt3-arm64/dist/SDL3-3.3.2-Linux.tar.gz SDL3-3.3.2-Linux/lib/libSDL3.so.0.3.2
mv SDL3-3.3.2-Linux/lib/libSDL3.so.0.3.2 fnalibs/libaarch64/libSDL3.so.0
