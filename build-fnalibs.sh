...
tar xvfz SDL-slrsniper/dist/SDL3-3.1.5-Linux.tar.gz SDL3-3.1.5-Linux/lib/libSDL3.so.0.1.5
mv SDL3-3.1.5-Linux/lib/libSDL3.so.0.1.5 fnalibs/lib64/libSDL3.so.0
...
mkdir -p fnalibs/x86
unzip SDL-VC-x86/dist/SDL3-3.1.5-Windows-VC.zip SDL3-3.1.5-Windows-VC/bin/SDL3.dll
mv SDL3-3.1.5-Windows-VC/bin/SDL3.dll fnalibs/x86/
...
mkdir -p fnalibs/x64
unzip SDL-VC-x64/dist/SDL3-3.1.5-Windows-VC.zip SDL3-3.1.5-Windows-VC/bin/SDL3.dll
mv SDL3-3.1.5-Windows-VC/bin/SDL3.dll fnalibs/x64/
